Feature: Create new rooms as an admin

  Scenario Outline: Create rooms
    ...
    Examples:
      ...
      | http://localhost:3003/ | "admin"  | "password" | "104" | "Family" | "true"     | 400   | "TV, WiFi, Radio, Safe" | "pass"   |
      | http://localhost:3003/ | "admin"  | "password" | ""    | "Double" | "false"    | 0     | ""                      | "fail"   |
